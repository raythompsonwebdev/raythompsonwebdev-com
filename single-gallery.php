	...
	<article class="post group" <?php post_class(); ?> <?php the_ID(); ?> >
		...
		<h1>Website/Web Application</h1>
			...
			<figure class="websiteImage">
			  <a href="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2018/07/www-<?php global $post;$post_slug = $post->post_name;echo esc_html( $post_slug, 'raythompsonwebdev-com' ); ?>-home-page-large.jpg" class="fancybox" title="<?php the_title_attribute(); ?> Website Image">

    ...
    <article class="post group" <?php post_class(); ?> <?php the_ID(); ?> >
        ...
        <h1><?php the_title(); ?></h1>
            ...
            <figure class="websiteImage">
              <a href="<?php echo home_url();?>/wp-content/uploads/2018/02/www-<?php global $post; $post_slug=$post->post_name; echo $post_slug; ?>-home-page-large.jpg" class="fancybox" title="<?php the_title_attribute() ?> Website Image">

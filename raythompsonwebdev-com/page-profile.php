                ...
                <div class="slider-body"><!--slider body -->
                    ...
                    <article class="panel" id="panel-1">
                        ...
                        <figure class="abobe">
                            ...
                            <a href="<?php echo esc_url(home_url('/') );?>/wp-content/uploads/2018/02/Large-Photoshop-Certicate-.jpg" class="fancybox" title="<?php esc_attr_e('Adobe Certificate in Visual Communication', 'raythompsonwebdev-com');?>">
                                <img src="<?php echo esc_url(home_url('/') );?>/wp-content/uploads/2018/02/Small-photoshop-Certicate.jpg" alt="<?php esc_attr_e('Adobe Certificate in Visual Communication', 'raythompsonwebdev-com');?>">
                            </a>
                    ...
                    <article class="panel" id="panel-2">
                        ...
                        <figure class="cert">
                            ...
                            <a href="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/ITQ-USERS-LEVEL1-LARGE.jpg" class="fancybox" title="<?php esc_attr_e('City and Guilds Level One, Two, Three', 'raythompsonwebdev-com');?>">

                                <img src="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/ITQ-USERS-LEVEL1-SMALL.gif" alt="<?php esc_attr_e('City and Guilds Level One, Two, Three', 'raythompsonwebdev-com');?>">
                    ...
                    <article class="panel" id="panel-3">
                        ...
                        <figure class="abobe">
                            ...
                            <a href="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/Large-Udemy-Certicate-.jpg" class="fancybox" title="<?php esc_attr_e('Udemy.com', 'raythompsonwebdev-com');?>">

                                <img src="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/Udemy-Small.jpg" alt="<?php esc_attr_e('Udemy.com', 'raythompsonwebdev-com');?>">
                    ...
                    <article class="panel" id="panel-4">
                        ...
                        <figure class="cert">
                            ...
                            <a href="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/FreeCodeCamp-large.png" class="fancybox" title="<?php esc_attr_e('FreeCode Camp', 'raythompsonwebdev-com');?>">

                                <img src="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/FreeCodeCamp-small.png" alt="<?php esc_attr_e('FreeCode Camp', 'raythompsonwebdev-com');?>">
                    ...
                    <article class="panel" id="panel-5">
                        ...
                        <figure class="abobe">
                            ...
                            <a 
                            href="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/lynda_logo1r-d_72x72.png" 
                            class="fancybox" 
                            title="<?php esc_attr_e('Lynda.com', 'raythompsonwebdev-com');?>">

                                <img 
                                src="<?php echo esc_url( home_url( '/' ) );?>/wp-content/uploads/2018/02/lynda_logo1k-d_72x72.png" 
                    ...
                    <article class="panel" id="panel-6">
                        ...
                        <figure class="cert">
                            ...
                            <a href="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Mobile-web-applications-Certificate-Foundation-large.jpg" class="fancybox" title="<?php esc_attr_e('Mobile-web-applications-Certificate-Foundation', 'raythompsonwebdev-com');?>">

                                <img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Mobile-web-applications-Certificate-Foundation-small.jpg" 
                    ...
                    <article class="panel" id="panel-7">
                        ...
                        <figure class="cert">
                            ...
                            <a href="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Digital-Marketing-Certificate-Foundation.jpg" class="fancybox" title="<?php esc_attr_e('Digital-Marketing-Certificate-Foundation', 'raythompsonwebdev-com');?>">

                                <img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Digital-Marketing-Certificate-Foundation-small.jpg" 
                    ...
                    <article class="panel" id="panel-8">
                        ...
                        <figure class="cert">
                            ...
                            <a href="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Content-Marketing-Certificate-Foundation.jpg" class="fancybox" title="<?php esc_attr_e('Digital-Marketing-Certificate-Foundation', 'raythompsonwebdev-com' );?>">

                                <img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Content-Marketing-Certificate-Foundation-Small.jpg" 
                                alt="<?php esc_attr_e('Digital-Marketing-Certificate-Foundation', 'raythompsonwebdev-com' );?>"
                    ...
                    <article class="panel" id="panel-9">
                        ...
                        <a href="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Digital-Futures-2017-Certificate-of-Participation-large.jpg" class="fancybox" title="<?php esc_attr_e('Digital-Futures-2017-Certificate-of-Participation','raythompsonwebdev-com');?>">
                            <img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/02/Digital-Futures-2017-Certificate-of-Participation-small.jpg" 

...
<article class="post group" <?php post_class(); ?> <?php the_ID(); ?> >
	...
	<div id="project-url">
		...
		<a class="webformats" href="<?php printf( '%s', esc_html( $raythompsonwebdev_com_project_code ), 'raythompsonwebdev-com' ); ?>" target="blank" title="<?php esc_attr_e( 'See Website', 'raythompsonwebdev-com' ); ?>"><?php printf( '%s', esc_html( $raythompsonwebdev_com_project_url ), 'raythompsonwebdev-com' ); ?></a>
	</div>
	...
	<div id="project-github">
		...
		<a class="webformats" href="<?php echo esc_url( 'https://github.com/raythompsonwebdev/', 'raythompsonwebdev-com' ); ?><?php printf( '%s', esc_html( $raythompsonwebdev_com_post_slug ), 'raythompsonwebdev-com' ); ?>" title="<?php esc_attr_e( 'See github repository', 'raythompsonwebdev-com' ); ?>">See Code on Github	</a>
	</div>

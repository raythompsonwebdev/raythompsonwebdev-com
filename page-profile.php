...
<p>
	<?php esc_html_e( 'Since then I spend lots of my spare time learning coding languages, practising coding,&nbsp;', 'raythompsonwebdev-com' ); ?>
	...
	<?php esc_html_e( '&nbsp;helping others with their websites in my spare time while working full-time. I became more interested in programming around 2016 after taking computer science fundementals courses on&nbsp;', 'raythompsonwebdev-com' ); ?>

	<strong><a href="<?php echo esc_url( 'http://www.linkedin.com/in/raymond-thompson-1b42b7b8', 'display' ); ?>" target="new">Lynda.com</a></strong>

	<?php esc_html_e( '&nbsp;that year and have since then found it easier to understand how and why coding languages like Javascipt, PHP and Ruby work the way they do.', 'raythompsonwebdev-com' ); ?></p>
		<p>
